...
class PersonalWalkAgent:
    ...
    RECOMMENDATION_ORDER = ["blue", "yellow", "orange", "violet", "white", "black", "green", "red"]
    ...
    def run(self, request: RecommendColorRequest) -> RecommendColorResponse:
        ...
        candidates = [
            color for color in self.RECOMMENDATION_ORDER if color not in recent
        ] or self.RECOMMENDATION_ORDER
